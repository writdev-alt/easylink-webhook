...
./scripts/deploy-cloudrun.sh YOUR_PROJECT_ID asia-southeast1

# Or specify a different Cloud SQL instance
./scripts/deploy-cloudrun.sh YOUR_PROJECT_ID asia-southeast1 base-image
```
...
# With all parameters
.\scripts\deploy-cloudrun.ps1 -ProjectId YOUR_PROJECT_ID -Region asia-southeast1 -CloudSqlInstance base-image
```
