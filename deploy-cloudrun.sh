...
# Usage: ./deploy-cloudrun.sh [project-id] [region] [cloud-sql-instance]
...
if [ -z "$PROJECT_ID" ]; then
    ...
    echo "Example: ./deploy-cloudrun.sh my-project-id us-central1 base-image"
    exit 1
fi
...
echo "./setup-cloudsql.sh $PROJECT_ID $REGION $CLOUD_SQL_INSTANCE"
